...
const TicTacToeProject = () => (
  <div className={styles.outerDiv}>
    <Typography variant = "display3" align = "center">Tic Tac Toe Game</Typography>
    <figure>
      <a
      ...
      <figcaption><Typography variant = "body2" align = "center">Click the screenshot to visit my project!</Typography></figcaption>
    </figure>
